...
class _DashboardsState extends State<Dashboards> {
  ...
  Future<void> getTerminalSelect() async {
    selectedBaseStationID =
        (baseStationList2.isNotEmpty ? baseStationList2[0].cityid : null)!;
    selectedBaseStation = baseStationList2[0].airportcode;
  ...
  changeValue() async {
    ...
    setState(() {
      ...
      if (dummyList.length == 1) {
        selectedBaseStationBranchID = dummyList[0].organizationBranchId;
        selectedBaseStationBranch = dummyList[0].orgBranchName;
        print("object------");
      }
    });
  }
  ...
  getBaseStationBranch(cityId) async {
    ...
    await Global()
      ...
      baseStationBranchList = responseObjectList
          .map((e) => WarehouseBaseStationBranch.fromJson(e))
          .toList();
                  ...
                  children: List<Widget>.generate(
                    ...
                    (int index) {
                      return Padding(
                        ...
                        child: ChoiceChip(
                          label: Text(
                            ' ${baseStationList2[index].airportcode}',
                          ),
