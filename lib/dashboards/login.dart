...
class _LoginPageState extends State<LoginPage> {
  ...
  getUserLocation() async {
    ...
    await Global()
        .getData(Settings.SERVICES['GetLocation'],
      queryParams,
    )
        .then((response) {
      print("data received ");
  ...
  Future<bool> loginUser(BuildContext context) async {
    try {
      ...
      await Global()
        ...
        if (json.decode(response.body)['ResponseObject'].toString().toLowerCase() ==
  ...
  getBaseStation() async {
    ...
    await Global()
      ...
      baseStationList2 = responseObjectList.map<WarehouseBaseStationTrucker>(
  ...
  Future<void> fetchIpInfo() async {
    try {
      ...
      print("check_data111=======${fetchedIpInfo.ip}");
