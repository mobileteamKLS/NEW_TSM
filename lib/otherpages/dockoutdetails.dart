...
class DockOutDetails extends StatefulWidget {
  ...
  @override
  State<DockOutDetails> createState() => _DockOutDetailsState();
}

class _DockOutDetailsState extends State<DockOutDetails> {
  ...
  Future<bool> submitForDockOut(modeType, checkin, dockin, dockout) async {
    try {
      // return true;
      errMsgText = "";
