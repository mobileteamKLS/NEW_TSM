...
import 'package:luxair/otherpages/vehiclemovementtrackingdetails.dart';
...
class VehicleMovementTrackingList extends StatefulWidget {
  const VehicleMovementTrackingList({Key? key}) : super(key: key);

  @override
  State<VehicleMovementTrackingList> createState() =>
      _VehicleMovementTrackingListState();
}
...
class _VehicleMovementTrackingListState
    extends State<VehicleMovementTrackingList> {
      ...
      body: Column(
          ...
          children: [
            HeaderClipperWave(
                ...
                headerText: "Vehicle Movement VT List"),
            // ClipPath(
            //   clipper: MyClippers1(),
            //   child: Container(
        ...
        ? GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => VehicleMovementTrackingDetails(
