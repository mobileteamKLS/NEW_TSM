...
class WarehouseAcceptanceList extends StatefulWidget {
  ...
  @override
  State<WarehouseAcceptanceList> createState() =>
      _WarehouseAcceptanceListState();
}

class _WarehouseAcceptanceListState extends State<WarehouseAcceptanceList> {
  ...
  void initState() {
    ...
    //   getDockInTokenList(1); //Import
    // else
    getWarehouseAcceptanceTokenList(5); //Export
    super.initState();
  }
        ...
        ? GestureDetector(
            onTap: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) =>
                        WarehouseAcceptanceAwbList(vtNumber: _dl.VTNo)),
              );
            },
            child: Card(
              child: ListTile(
...
// This function is called whenever the text field changes
  void _runFilter(String enteredKeyword) {
    ...
    print(enteredKeyword.length.toString());
        ...
        if (!enteredKeyword.startsWith("E")) {
          if (enteredKeyword.startsWith("0")) {
            ...
            if (isSearched) {
              ...
              print("results.length after filter == " +
