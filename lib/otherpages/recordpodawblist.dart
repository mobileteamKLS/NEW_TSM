...
import 'package:luxair/otherpages/recordpoddetails.dart';
...
class RecordPodAwbList extends StatefulWidget {
  ...
  @override
  State<RecordPodAwbList> createState() => _RecordPodAwbListState();
}

class _RecordPodAwbListState extends State<RecordPodAwbList> {
  ...
  List<PODAWB> dockInOutVTListToBind = [];
  //List<DockInOutVT> dockInOutVTListImport = [];
  List<PODAWB> dockInOutVTListExport = [];
  List<PODAWB> dockInOutVTListRandom = [];
  ...
  void initState() {
    ...
    getWarehouseAcceptanceAWBList(1); //Import
    super.initState();
  }
                ...
                title: useMobileLayout
                    ? Column(
                        ...
                        children: [
                          ...
                          if (_dl.HAWBNumber != "") SizedBox(height: 5),
    ...
    if (enteredKeyword.isEmpty) {
      ...
      if (enteredKeyword.isEmpty) {
        ...
        if (isSearched) {
          ...
          results.retainWhere((PODAWB element) =>
